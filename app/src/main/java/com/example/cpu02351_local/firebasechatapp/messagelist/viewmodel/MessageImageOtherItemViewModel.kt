...
class MessageImageOtherItemViewModel(messageItem: MessageItem, var v: View, private val imageClick: MessageItemAdapter.ItemClickCallback) : MessageOtherItemViewModel(messageItem) {
    fun imageClicked() {
